...
## Standard 12 września

- Selekcja: [STANDARD_SELEKCJI.md](STANDARD_SELEKCJI.md) · UI `/selekcja`
- **Sitko kuponu 2×2** — na dwójkę tylko CORE **1:0 / 0:1** + BTTS NIE albo U2.5
- **1B OUT** · Conf nie tnie listy ani dwójki
- Pulpit **bez listy dnia** — mecze dodajesz sam
- Archiwum **2 h po HIT/MISS**
- Silnik **K0–K18 HOLD**
